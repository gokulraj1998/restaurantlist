...
function Details() {
  ...
  return (
    <div><Link className="btn btn-outline-dark rounded my-2 btn-sm" to="/" >Back
      </Link>
      {details? (
        <Row  className='my-3'>
          <Col md={3}>
         ...
         <Col md={4}>
          <ListGroup>
            <ListGroup.Item>
              <h2>{details.name}</h2>
              <p>{details.neighborhood}</p></ListGroup.Item>
              <ListGroup.Item>
                <p>Cuisine:{details.cuisine_type}</p></ListGroup.Item>
                <ListGroup.Item><p> Address:{details.address}</p></ListGroup.Item></ListGroup></Col> 
      <Col md={4}>
        <ListGroup>
          <ListGroup.Item>
